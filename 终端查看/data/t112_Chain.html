...
//Chain 连锁控件
Ext.define('Jit.biz.Chain', {
    alias: 'widget.jitbizchain',
    constructor: function (args) {
        ...
        if (args.isTree) {
            defaultConfig = {
                url: '/Framework/Javascript/Biz/Handler/ChainHandler.ashx?method=GetChainByParentID&IsTree=success&ParentID=' + args.parentID    //树的数据从后台加载
            ...
            instance.jitSetValue = function (value) {
                if (value != null && value.toString() != "") {
                    ...
                    Ext.Ajax.request({
                        url: "/Framework/Javascript/Biz/Handler/ChainHandler.ashx?method=GetChainByID&ChainID="
					        + values,
                        method: 'get',
            ...
            store.proxy.url = "/Framework/Javascript/Biz/Handler/ChainHandler.ashx?method=GetChainByParentID&IsTree=false&ParentID=" + args.parentID;
          
            defaultConfig = {
                store: store
                        , valueField: 'ChainID'
                        , displayField: 'ChainName'
            };
            args = Ext.applyIf(args, defaultConfig);
