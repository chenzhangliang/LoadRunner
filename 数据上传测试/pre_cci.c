# 1 "c:\\documents and settings\\administrator\\\327\300\303\346\\\260\242\300\357\324\306\275\305\261\276\\\312\375\276\335\311\317\264\253\262\342\312\324\\\\combined_\312\375\276\335\311\317\264\253\262\342\312\324.c"
...
# 1 "c:\\documents and settings\\administrator\\\327\300\303\346\\\260\242\300\357\324\306\275\305\261\276\\\312\375\276\335\311\317\264\253\262\342\312\324\\\\combined_\312\375\276\335\311\317\264\253\262\342\312\324.c" 2
...
# 1 "C:\\Program Files\\HP\\LoadRunner\\include/mic_ftp.h" 1
...
typedef unsigned long FTP_REPLAY_INFO, *FTP;


int ftp_logon(const char *transaction, const char *url, ...);
int ftp_logon_ex(FTP *ppftp,const char *transaction, const char *url, ...);

int ftp_logout();
int ftp_logout_ex(FTP *ppftp);

int ftp_get (const char *transaction, ...);
int ftp_get_ex(FTP *ppftp,const char *transaction, ...);

int ftp_put (const char *transaction, ...);
int ftp_put_ex(FTP *ppftp,const char *transaction, ...);

int ftp_delete (const char *transaction, ...);
int ftp_delete_ex(FTP *ppftp,const char *transaction, ...);

int ftp_mkdir (const char *transaction, const char * path);
int ftp_mkdir_ex(FTP *ppftp, const char *transaction, const char * path);

int ftp_dir (const char *transaction, ...);
int ftp_dir_ex(FTP *ppftp,const char *transaction, ...);
...
int ftp_rendir (const char *transaction, ...);
int ftp_rendir_ex(FTP *ppftp, const char *transaction, ...);

int ftp_rmdir (const char *transaction, const char * path);
int ftp_rmdir_ex(FTP *ppftp, const char *transaction, const char * path);

int ftp_get_last_download_details (unsigned long * size, unsigned long *duration);
int ftp_get_last_download_details_ex (FTP *ppftp, unsigned long * size, unsigned long *duration);
...
int ftp_set_option(FTP *ppftp, const char *transaction, ...);
...
# 2 "c:\\documents and settings\\administrator\\\327\300\303\346\\\260\242\300\357\324\306\275\305\261\276\\\312\375\276\335\311\317\264\253\262\342\312\324\\\\combined_\312\375\276\335\311\317\264\253\262\342\312\324.c" 2
...
# 4 "c:\\documents and settings\\administrator\\\327\300\303\346\\\260\242\300\357\324\306\275\305\261\276\\\312\375\276\335\311\317\264\253\262\342\312\324\\\\combined_\312\375\276\335\311\317\264\253\262\342\312\324.c" 2

# 1 "Action.c" 1
Action()
 {
	 unsigned long *ftp_session=0;
	 char *address="D:\\FTP\\01.txt";  
     long filename; 
   ...
   web_custom_request("ListThemes",
					  ...
					  "URL=http://112.124.9.72:3005/Impls/TableModeDataSync.svc/ProcessRequest", 
                       ...
                       "RecContentType=application/json",
						...
						"Body={\"pRequest\":{\"UploadFile\":[\"DataSyncTesting\/{FileName}\"],\"UserID\":\"{User}\",\"Token\":\"\",\"LastUpdateTime\":\"2013-07-16 11:40:11 290\",\"Version\":\"1\",\"OperationCode\":1,\"Platform\":\"SCH-I779\",\"ClientID\":\"58\"}}",
						"TargetFrame=",
   ...
   lr_end_transaction("WCF调用", 2);


    if ((filename=fopen(address,"a+"))==0) 
    {
...
# 5 "c:\\documents and settings\\administrator\\\327\300\303\346\\\260\242\300\357\324\306\275\305\261\276\\\312\375\276\335\311\317\264\253\262\342\312\324\\\\combined_\312\375\276\335\311\317\264\253\262\342\312\324.c" 2
...
# 6 "c:\\documents and settings\\administrator\\\327\300\303\346\\\260\242\300\357\324\306\275\305\261\276\\\312\375\276\335\311\317\264\253\262\342\312\324\\\\combined_\312\375\276\335\311\317\264\253\262\342\312\324.c" 2
